 ...
 * to send analytic data that can be viewed on the BackflowInspection Dashboard.
 *
 * For information on getting started with BackflowInspection Platform Services,
