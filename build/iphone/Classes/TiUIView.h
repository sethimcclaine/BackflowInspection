...
/**
 Base class for all BackflowInspection views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BackflowInspection view hierarchy (such as wrapped iOS UIViews) was touched.
