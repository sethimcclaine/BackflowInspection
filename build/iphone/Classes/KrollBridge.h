...
@interface BackflowInspectionObject : KrollCoverageObject {
#else
@interface BackflowInspectionObject : KrollObject {
#endif
@private
...
extern NSString * BackflowInspection$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BackflowInspectionObject *_backflowinspection;
    KrollObject* console;
	BOOL shutdown;
