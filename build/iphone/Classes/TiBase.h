...
// in simulator we redefine to format for BackflowInspection Developer console
...
{\
	NSString * exceptionName = [@"org.backflowinspection." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.backflowinspection";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBackflowInspectionNativeItemNone = -1, 
	UIBackflowInspectionNativeItemSpinner = -2,
	UIBackflowInspectionNativeItemProgressBar = -3,
	
	UIBackflowInspectionNativeItemSlider = -4,
	UIBackflowInspectionNativeItemSwitch = -5,
	UIBackflowInspectionNativeItemMultiButton = -6,
	UIBackflowInspectionNativeItemSegmented = -7,
	
	UIBackflowInspectionNativeItemTextView = -8,
	UIBackflowInspectionNativeItemTextField = -9,
	UIBackflowInspectionNativeItemSearchBar = -10,
	
	UIBackflowInspectionNativeItemPicker = -11,
	UIBackflowInspectionNativeItemDatePicker = -12,
	
	UIBackflowInspectionNativeItemInfoLight = -13,
	UIBackflowInspectionNativeItemInfoDark = -14,
	
	UIBackflowInspectionNativeItemDisclosure = -15,
	
	UIBackflowInspectionNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BackflowInspection instances of
