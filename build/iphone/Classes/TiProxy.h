...
//Rare exceptions to indicate a bug in the _backflowinspection code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BackflowInspection proxies.
 */
