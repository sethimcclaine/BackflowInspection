...
//@interface BackflowInspectionObject : NSObject
//@end

@interface BackflowInspectionObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BackflowInspectionObject class]])
		{
			for (NSString *key in [[(BackflowInspectionObject*)o modules] allKeys])
			{
